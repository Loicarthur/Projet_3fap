...
<div class="container">
     ...
     <div class="btn-container">
        <a href="creer_activite.php" class="btn btn-primary">Ajouter une nouvelle activité</a>
    </div>
    ...
    foreach ($activities as $activity) {
        ...
        echo '<a href="edit_activite.php?id=' . $activity['id'] . '">Modifier</a>';
        echo '<button onclick="deleteActivite(' . $activity['id'] . ')">Supprimer</button>';
        echo '</div>';
        echo '</div>';
    }
